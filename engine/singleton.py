...
ITER_CHUNK_3x3 = [(i, j) for i in range(-1, 2) for j in range(-1, 2)]
...
def set_render_distance(distance: int):
    """ Set the render distance """
    global DEFAULT_CHUNK_RENDER_DISTANCE
    DEFAULT_CHUNK_RENDER_DISTANCE = [distance]
